...
function WicabelTuning:init(enemy, battler, isdouble, battler2)
    super.init(self, 0, 0)
...
function WicabelTuning:onPress()
    ...
    if bar_x >= 196 and bar_x <= 224 then
        ...
        if self.double then
            self.battler2:setAnimation("battle/attack", function() self.battler2:setAnimation("battle/idle") end)
        else
