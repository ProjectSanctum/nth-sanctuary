...
function map:makeVaporRipple()
    self.world:spawnObject(VaporRipple(love.math.random(0, SCREEN_WIDTH), love.math.random(0, SCREEN_HEIGHT),  self.spawncolor, 60, love.math.random(2, 4), nil, 10), 999999)
end
