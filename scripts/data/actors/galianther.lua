local Galianther, super = Class(Actor)
...
function Galianther:init()
    ...
    self.path = "battle/enemies/galianther"
...
function Galianther:createSprite()
    return GaliantherActorSprite(self)
end

function Galianther:onSetAnimation(sprite, anim, ...)
    local args = {...}
