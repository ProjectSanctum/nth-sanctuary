local actor, super = Class(Actor, "cuptain_party")
...
function actor:init()
    ...
    self.animations = {
        ...
        ["battle/defeat"]       = {"battle/hurt", 1/15, false},
        ["battle/swooned"]      = {"battle/hurt", 1/15, false},
